              ...
              >
                ...
                <ul className="mt-5 flex flex-1 flex-col gap-4">
                  {tier.included.map((benefitIndex) => (
                    ...
                    >
                      <Check className={["mt-1 h-4 w-4 shrink-0", tier.featured ? "text-white" : "text-[#ef3434]"].join(" ")} aria-hidden="true" />
                ...
                <a
                  ...
                  className={[
                    ...
                    tier.featured
                      ...
                      : "border border-[#ef3434]/70 text-[#ef3434] hover:bg-[#ef3434] hover:text-white",
                  ].join(" ")}
                >
                  Contact Us
                </a>
